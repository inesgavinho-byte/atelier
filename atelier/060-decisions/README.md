...
| `ADR-0005-sessoes-timeline-chat-interface.md` | Sessões, Timeline e Chat como Interface | Proposed | Fatia 1 (projectos) + Timeline implementadas; Sessões por fazer |
