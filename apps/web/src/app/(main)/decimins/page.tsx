...
export const metadata = { title: "Decimins — ATELIER" };
 ...
 */
export default async function DeciminsPage() {
    ...
    return (
      <div>
        <header className="mb-10">
          ...
          <h1 className="atelier-title">Decimins</h1>
          <p className="atelier-subtitle">
            A tua equipa invisível de preparação.
          </p>
        </header>
        <p className="panel p-4 meta">
          Define SUPABASE_SERVICE_ROLE_KEY no ambiente para ver os Decimins (as
  ...
  return (
    <div>
      ...
      {minions.length === 0 ? (
        <p className="panel p-4 meta">Ainda não há Decimins configurados.</p>
      ) : (
        <MinionsBoard
          minions={minions}
